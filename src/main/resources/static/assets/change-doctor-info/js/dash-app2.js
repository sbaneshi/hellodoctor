...
$(document).ready(function() {
    myPrescriptions.on("load", loadPrescriptions());
    myFinancials.on("load", loadFinancials());
    myAppointments.on("load", loadAppointments());
...
myNotifications.on("click", removeNotif);
//classes
